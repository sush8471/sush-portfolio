        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
          ...
          <motion.div
            ...
            <div className="pt-4 sm:pt-6 grid grid-cols-2 gap-4 sm:gap-6">
                <div>
                    <h4 className="text-3xl sm:text-4xl font-bold text-foreground">24/7</h4>
                    <p className="text-xs sm:text-sm text-muted-foreground mt-1">Automated Workflows</p>
                </div>
                 <div>
                    <h4 className="text-3xl sm:text-4xl font-bold text-foreground">6+</h4>
                    <p className="text-xs sm:text-sm text-muted-foreground mt-1">Production Apps Shipped</p>
                </div>
            </div>
          </motion.div>
        </div>
