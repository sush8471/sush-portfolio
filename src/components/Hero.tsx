import { ArrowRight, Mail, MapPin, Cpu, Check, Download } from "lucide-react";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div className="lg:col-span-7 max-w-full">
          ...
          <p className="mt-4 sm:mt-5 text-base sm:text-xl lg:text-2xl leading-relaxed text-muted-foreground tracking-tight max-w-xl">
            Full-Stack AI Developer building intelligent tools that solve real problems. I turn ideas into working products — fast.
          </p>

          <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row gap-3 flex-wrap">
            <a
              href="#projects"
            ...
            <a
              href="https://i.ibb.co/WNqT3Ldp/Sushant-Chaudhary-Professional-Resume.jpg"
              target="_blank"
          ...
          <div className="mt-8 sm:mt-10 grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="flex items-start gap-3 border-t border-border pt-4">
              ...
              <div>
                <p className="text-sm font-medium tracking-tight text-foreground">AI + Full-Stack</p>
                <p className="text-xs text-muted-foreground mt-0.5">React, Node, Python, LLMs</p>
              </div>
            </div>
            <div className="flex items-start gap-3 border-t border-border pt-4">
              <Check className="w-[18px] h-[18px] text-muted-foreground mt-0.5 flex-shrink-0" />
              <div>
                <p className="text-sm font-medium tracking-tight text-foreground">Available now</p>
                <p className="text-xs text-muted-foreground mt-0.5">Open to freelance & roles</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 right-3 sm:right-4 grid grid-cols-3 gap-2 sm:gap-3">
              <div className="rounded-xl bg-black/20 backdrop-blur-md border border-white/10 p-2 sm:p-3 shadow-lg">
                <div className="flex items-center gap-1.5 sm:gap-2 mb-0.5 sm:mb-1">
                  ...
                  <div className="text-sm sm:text-lg font-semibold tracking-tight text-white leading-tight">6+ Tools</div>
                </div>
                <p className="text-[9px] sm:text-[11px] text-white/70">shipped to production</p>
              </div>
              <div className="rounded-xl bg-black/20 backdrop-blur-md border border-white/10 p-2 sm:p-3 shadow-lg">
                <div className="flex items-center gap-1.5 sm:gap-2 mb-0.5 sm:mb-1">
                  <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-yellow-400/80 flex-shrink-0" />
                  <div className="text-sm sm:text-lg font-semibold tracking-tight text-white leading-tight">Zero Config Deploys</div>
                </div>
                <p className="text-[9px] sm:text-[11px] text-white/70">ship in minutes, not days</p>
              </div>
              <div className="rounded-xl bg-black/20 backdrop-blur-md border border-white/10 p-2 sm:p-3 shadow-lg">
                <div className="flex items-center gap-1.5 sm:gap-2 mb-0.5 sm:mb-1">
                  <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-blue-400/80 flex-shrink-0" />
                  <div className="text-sm sm:text-lg font-semibold tracking-tight text-white leading-tight">AI-First</div>
                </div>
                <p className="text-[9px] sm:text-[11px] text-white/70">modern stack</p>
              </div>
            </div>
          </div>
        </div>
